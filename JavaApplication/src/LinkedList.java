...
public class LinkedList {
    ...
    public LinkedList() {
     ...
     public Customer getInfo(String idcard)
     {
           Node temp=head;
           ...
           while(temp!=null)
           {
               ...
               if(idcard.equals(temp.getCustomer().getIdcard()))
    ...
    boolean isExist(String text) {
      Node temp=head;
           ...
           while(temp!=null)
           {
               ...
               if(text.equals(temp.getCustomer().getIdcard()))
               {
                   return true;
               }
               temp=temp.getPre();
    ...
    String CnicInfo(String text) {
         Node temp=head;
           ...
           while(temp!=null)
           {
               ...
               if(text.equals(temp.getCustomer().getIdcard()))
               {
                   return "\nIDCard                          ="+temp.getCustomer().getIdcard()
    ...
    Node temp=head;
           ...
           while(temp!=null)
           {
               ...
               if(cuss.getIdcard().equals(temp.getCustomer().getIdcard()))
               {
