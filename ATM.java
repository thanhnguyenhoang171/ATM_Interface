...
public class ATM {
    ...
    public static void main(String[] args) {
		...
		Bank theBank = new Bank("OU Bank");
		User newUser1 = theBank.addUser("Quan", "Vu", "1234");
		User newUser2 = theBank.addUser("Thanh", "Hoang", "1236");
		User newUser3 = theBank.addUser("Dat", "Nguyen", "2345");
        Account newAccount1 = new Account ("Savings" , newUser1 , theBank);
        newUser1.addAccount(newAccount1);
		theBank.addAccount(newAccount1);
		
		Account newAccount2 = new Account("savings", newUser2, theBank);
		newUser2.addAccount(newAccount2);
		theBank.addAccount(newAccount2);

		Account newAccount3 = new Account("savings", newUser3, theBank);
		newUser3.addAccount(newAccount3);
    ...
    public static void depositeFunds(User theUser , Scanner sc){
		...
		do {
			System.out.printf("Enter the amount to deposite : $", 
					acctBal);
			amount = sc.nextDouble();
			if (amount < 0) {
				System.out.println("Amount must be greater than zero.");
